...
namespace StructureHelper
{
    public struct LegacyTileSaveData : TagSerializable
    {
        ...
        public LegacyTileSaveData(bool active, string tile, string wall, short frameX, short frameY, short wFrameX, short wFrameY, byte slope, bool halfSlab, bool hasActuator, bool actuated, byte liquid, byte liquidType, byte color, byte wallColor, byte[] wire, string teType, TagCompound teData)
        {
            Active = active;
            Tile = tile;
            Wall = wall;
        ...
        public static Func<TagCompound, LegacyTileSaveData> DESERIALIZER = s => DeserializeData(s);
        public static LegacyTileSaveData DeserializeData(TagCompound tag)
        {
            return new LegacyTileSaveData(
            tag.GetBool("Active"),
            tag.GetString("Tile"),
            tag.GetString("Wall"),
            tag.GetShort("FrameX"),
